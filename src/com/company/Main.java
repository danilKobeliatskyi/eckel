...
public class Main {
    ...
    public static void cookingMetod(int i, char l) {
        System.out.println("woter: " + i + ", liters:" + 'l');
    }

    public static void cookingMetod(char l, int i) {
        System.out.println("liters:" + 'l'+ ", woter" + i);
    }
